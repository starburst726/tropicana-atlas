...
async function load(initial=false){
 ...
 const review=corrections.unmatched.length+corrections.ambiguous.length;$('#road-status').textContent=`${corrections.applied.length} reviewed road corrections applied${review?' · '+review+' need review':''}`;if(!features.length)throw new Error('No map features');
